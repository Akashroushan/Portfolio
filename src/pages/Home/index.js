...
const disciplines = ['UI Designer', 'Coder'];
...
const Home = () => {
  ...
  return (
    <div className="home">
      <Helmet>
        <title>Akash Roushan | Mobile Developer</title>
        <meta
          name="description"
          content="Portfolio of Akash Roushan – a multidisciplinary UI designer & Android developer with a focus on motion and user experience."
        />
      ...
      <ProjectSummary
        ...
        index={1}
        title="MyPantry - Ecommerce App"
        description="Design and development of an Android E-Commerce Application through Android Studio and Firebase."
        buttonText="View"
      ...
      <ProjectSummary
        ...
        index={2}
        title="Dispatch - A Chat App"
        description="Dispatch is an encrypted messaging app and for many, is a secure way to communicate with friends and family because of its end-to-end encryption"
        buttonText="View"
      ...
      />
       <ProjectSummary
        ...
        index={4}
        title="Fitness App "
        description="Basic Fitness app for step counting and calorie counter"
        buttonText="View"
        //buttonLink="/projects/device-models"
        model={{
          type: 'phone',
